          ...
          <div className="flex py-0 px-4 items-center gap-4 rounded-lg bg-[#F7F7F7] w-full h-10">
            <div className="w-6 h-6 overflow-hidden relative">
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="w-[18px] h-5 absolute left-[3px] top-0.5 "
              >
                <path
              ...
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="w-1.5 h-2.5 absolute left-[9px] top-3 "
              >
                <path
                  d="M1 11V1H7V11"
                  stroke="black"
          ...
          <div className="flex py-0 px-4 items-center gap-4 rounded-lg bg-[#FFF] w-full h-10">
            <div className="w-6 h-6 overflow-hidden relative">
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="w-[13px] absolute left-2 top-1.5 "
              >
                <path
                  d="M1 1H14"
                  stroke="black"
              ...
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="w-[13px] absolute left-2 top-3 "
              >
                <path
                  d="M1 1H14"
                  stroke="black"
              ...
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="w-[13px] absolute left-2 top-[18px] "
              >
                <path
                  d="M1 1H14"
                  stroke="black"
              ...
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="w-0 absolute left-[3px] top-1.5 "
              >
                <path
                  d="M1 1H1.01"
                  stroke="black"
              ...
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="w-0 absolute left-[3px] top-3 "
              >
                <path
                  d="M1 1H1.01"
                  stroke="black"
              ...
              <svg
                ...
                fill="none"
                xmlns="http://www.w3.org/2000/svg"
                className="w-0 absolute left-[3px] top-[18px] "
              >
                <path
                  d="M1 1H1.01"
                  stroke="black"
